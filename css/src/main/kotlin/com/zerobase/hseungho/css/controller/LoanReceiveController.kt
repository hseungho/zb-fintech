package com.zerobase.hseungho.css.controller

import com.zerobase.hseungho.css.dto.LoanRequestDto
import com.zerobase.hseungho.css.dto.LoanResultDto
import com.zerobase.hseungho.css.service.LoanReviewService
...
class LoanReceiveController(
    ...
    @PostMapping("/request")
    fun loanReceive(
            @RequestBody requestDto: LoanRequestDto.RequestInputDto
    ) : LoanResultDto.ResponseDto =
            loanReviewService.loanReview(requestDto)
