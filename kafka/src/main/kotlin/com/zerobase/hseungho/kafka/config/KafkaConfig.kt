package com.zerobase.hseungho.kafka.config
...
class KafkaConfig {
    ...
    fun producerFactory() : ProducerFactory<String, String> {
        ...
        configurationProperties[ProducerConfig.BOOTSTRAP_SERVERS_CONFIG] = boostrapServer
    ...
    fun consumerFactory(): ConsumerFactory<String, String> {
        val configurationProperties = HashMap<String, Any>()
        configurationProperties[ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG] = boostrapServer
